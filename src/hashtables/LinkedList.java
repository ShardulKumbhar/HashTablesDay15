...
public class LinkedList<K> {
	...
	/**
	 * Method to search for a specific key in the HashTable. 
	 * 1. declare a variable
	 * of type node and assign it to head 
	 * 2. Traverse the list till it is not null
	 * to match every element with input key 
	 * 3. If matched return node. If key not
	 * return null
	 * 
